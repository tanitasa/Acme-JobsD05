...
<acme:list-column code="administrator.challenge.form.label.title"  width="5%" path="title" />
<acme:list-column code="administrator.challenge.form.label.deadline"  width="5%" path="deadline" />
<acme:list-column code="administrator.challenge.form.label.description"  width="5%" path="description" />
