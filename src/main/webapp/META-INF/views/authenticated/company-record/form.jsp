...
<acme:form readonly="true">
	...
	<acme:form-textbox code="authenticated.companyRecord.form.label.web" path="web"/>
	<acme:form-textbox code="authenticated.companyRecord.form.label.phoneNumber" path="phoneNumber"/>
	<acme:form-textbox code="authenticated.companyRecord.form.label.email" path="email"/>
	<acme:form-textbox code="authenticated.companyRecord.form.label.isIncorporated" path="isIncorporated"/>
